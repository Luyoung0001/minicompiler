...
layout: 'course_page'
permalink: '/course/practice/labs/lab02-step2/'
lab: 'Lab02'
step: 'step_2'
hours: '3h'
deliverable: '完成最小 lexer 骨架，正确识别空白、标识符、数字'
source_path: 'course/practice/labs/lab02-step2/TASK.md'
---


> **实验编号** Lab02 &nbsp;&nbsp; **预计耗时** 3h &nbsp;&nbsp; **对应参考实现** [`step_2/`](https://github.com/Luyoung0001/minicompiler/tree/main/step_2) &nbsp;&nbsp; **本节产出** 生成正确的 token 序列
