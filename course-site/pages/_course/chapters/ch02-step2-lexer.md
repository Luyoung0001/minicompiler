...
layout: 'course_page'
permalink: '/course/chapters/ch02-step2-lexer/'
prev_page:
...
1. [Lab02 - step_2 词法分析器](/course/practice/labs/lab02-step2/)
2. 观察 token 序列是否和讲义预期一致
3. 然后继续进入 [Chapter 3 — 语法分析器与 AST](/course/chapters/ch03-step3-parser/)
