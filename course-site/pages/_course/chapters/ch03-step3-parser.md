---
title: 'Chapter 3 — step_3 递归下降解析器与抽象语法树'
layout: 'course_page'
permalink: '/course/chapters/ch03-step3-parser/'
prev_page:
  title: 'Chapter 2 — step_2 词法分析器：把源码切成 token 流'
  url: '/course/chapters/ch02-step2-lexer/'
next_page:
...
1. [Lab03 - step_3 语法分析与 AST](/course/practice/labs/lab03-step3/)
2. 对照验证输出，确认 AST 形状正确
3. 然后继续进入 [Chapter 4 — 符号表与语义分析](/course/chapters/ch04-step4-semantic/)
