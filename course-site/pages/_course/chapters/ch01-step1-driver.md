...
layout: 'course_page'
permalink: '/course/chapters/ch01-step1-driver/'
prev_page:
...
source_path: 'course/chapters/ch01-step1-driver.md'
---

> **对应实践**：[Lab01 - step_1 最小驱动](/course/practice/labs/lab01-step1/)  
...
1. [Lab01 - step_1 最小驱动](/course/practice/labs/lab01-step1/)
2. 跑通 `make clean && make test`
3. 然后继续进入 [Chapter 2 — 词法分析器](/course/chapters/ch02-step2-lexer/)
