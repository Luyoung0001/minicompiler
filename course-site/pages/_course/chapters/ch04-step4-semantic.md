...
layout: 'course_page'
permalink: '/course/chapters/ch04-step4-semantic/'
prev_page:
  title: 'Chapter 3 — step_3 递归下降解析器与抽象语法树'
  url: '/course/chapters/ch03-step3-parser/'
next_page:
  title: 'Chapter 5 — step_5 RISC-V 代码生成与 QEMU 运行'
  url: '/course/chapters/ch05-step5-codegen/'
source_path: 'course/chapters/ch04-step4-semantic.md'
---

> **对应实践**：[Lab04 - step_4 语义分析](/course/practice/labs/lab04-step4/)  
...
1. [Lab04 - step_4 语义分析](/course/practice/labs/lab04-step4/)
2. 观察未定义变量和重复定义是否被正确报出
3. 然后进入 [Chapter 5 — RISC-V 代码生成](/course/chapters/ch05-step5-codegen/)
