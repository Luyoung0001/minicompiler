...
1. 先读 [Chapter 0](00-orientation.md)，把工具链检查清楚，并拉取 lab 仓库。
2. 在本地 clone `https://github.com/Luyoung0001/miniCompiler_lab.git`，运行第一次 smoke test。
3. 再进入 [Practice 与实验说明](practice/README.md)，确认这一门课的 lab 怎么使用。
4. 从 [Chapter 1](chapters/ch01-step1-driver.md) 开始正式课程。
...
4. 然后继续进入 [Chapter 1](chapters/ch01-step1-driver.md)
